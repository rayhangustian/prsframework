...
export const reviewerPrompt = (xml) => `Role: Surgical Review Board. Evaluate for safety, completeness, standard of care. Be strict but pragmatic.
...
export async function generatePlan({ client, caseText, model, reasoningEffort, verbosity, modelDefault }) {
  ...
  const result = { verdict, source, reason, comment, manager_note, xml: planXml, raw_review };
